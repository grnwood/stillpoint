        ...
        HelpPage(
            ...
            content="\n".join(
                [
                    ...
                    "- `Enter` on a selected task opens it and focuses the editor.",
                    "- `Ctrl+Enter` or `Shift+Enter` opens it and keeps focus in the task list.",
        ...
        HelpPage(
            ...
            content="\n".join(
                [
                    ...
                    "- In the Map tab, `Alt+Up` / `Alt+Down` zoom in/out around the selected node",
                    "- In the Map tab, `Alt+J` / `Alt+K` also zoom in/out around the selected node",
                    "- In the Map tab, `f` fits the visible map in the viewport",
