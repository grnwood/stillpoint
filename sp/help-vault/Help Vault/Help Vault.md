...
Welcome to the StillPoint Help Vault. This is a real StillPoint vault made of plain Markdown files. You can browse it like any other vault and copy anything into your own notes.
...
- Links, tags, tasks, and search work together.

## Topics
- Writing and formatting: [:Editing|Editing]
...
- Design principles: [:Design_Philosophy|Design Philosophy]
- If something goes wrong: [:Troubleshooting|Troubleshooting]

## Link Format
StillPoint uses wiki-style links like this:

`[:Page_Name|Nice label]`

If a page has spaces, use underscores in the link target. StillPoint resolves it back to spaces.